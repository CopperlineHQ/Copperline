...
- **Peripherals**: a bit-timed keyboard (6500/1 MCU), mouse, USB gamepad
  ...
  DrawBridge / Greaseweazle / SuperCard Pro via the safe Rust FluxBridge crate,
...
| Display window | winit 0.30 + pixels 0.17 surface; 716x285 framebuffer presented in the live window at 4:3 (716x537) plus a 44-pixel status bar with power/disk controls. TV-mode PNG screenshots and frame dumps crop the standard PAL field to a 692x540 aperture. |
