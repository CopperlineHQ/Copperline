...
pub struct Emulation {
    ...
    /// input sampled during the iteration therefore lands in guest time up to
    ...
    /// speed; ignored while warp, reverse history, or RTG display is active.
...
/// many guest animation frames reads as rubber-banding (the run-ahead
/// trade-off documented by peers).
