        ...
        match self.pending.as_ref()? {
            ...
            PendingBlit::Line(state) => {
                ...
                Some(BlitBusAccess {
                    ...
                    data: access.2,
                    write: access.3,
                    final_d: access.0 == 3 && state.npixels_remaining == 1,
                    line: true,
                    fill: false,
                })
            }
